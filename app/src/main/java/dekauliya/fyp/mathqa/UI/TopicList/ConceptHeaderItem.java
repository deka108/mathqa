...
public class ConceptHeaderItem extends AbstractExpandableHeaderItem<ConceptHeaderItem
    ...
    static class ConceptHeaderItemViewHolder extends ExpandableViewHolder{
        ...
        public ConceptHeaderItemViewHolder(View view, FlexibleAdapter adapter) {
            ...
            mConceptTitle = (TextView) view.findViewById(R.id.rv_header_title_text);
        }
