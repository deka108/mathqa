...
import dekauliya.fyp.mathqa.dummy.UI.AAR.Data.IListener;
import dekauliya.fyp.mathqa.ListViews.Items.ConceptHeaderItem;
import dekauliya.fyp.mathqa.ListViews.Items.ConceptSubItem;
import dekauliya.fyp.mathqa.dummy.TopicList.FlexibleAdapter.AbstractItem;
...
public class DataServiceRef {
    private static DataServiceRef mInstance;
...
//    }
//
//    public static DataServiceRef getInstance(){
//        if (mInstance == null){
//            mInstance = new DataServiceRef();
//        }
//        return mInstance;
//    }
