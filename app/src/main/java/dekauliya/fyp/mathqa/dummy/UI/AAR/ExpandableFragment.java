...
public class ExpandableFragment
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.aar_fragment_recycler_list_view, container, false);
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        mRecyclerView = (RecyclerView) getView().findViewById(R.id.aar_recycler_view);
...
//        ((TestRecyclerMathView) getActivity()).getDataProvider();
//    }
}
